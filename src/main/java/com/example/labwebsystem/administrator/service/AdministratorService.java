...
public class AdministratorService {
    ...
    //科研论文
    @Transactional
    public int insertResearchPapers(List<ResearchPaper> researchPaperList) throws RuntimeException {
    ...
    @Transactional
    public int deleteResearchPapers(List<Integer> researchPaperIdList) throws RuntimeException{
    ...
    //专利
    @Transactional
    public int insertPapents(List<Papent> papentList) throws RuntimeException {
    ...
    @Transactional
    public int deletePapents(List<Integer> papentIdList) throws RuntimeException{
    ...
    //著作权
    @Transactional
    public int insertCopyRights(List<CopyRight> copyRightList) throws RuntimeException{
    ...
    @Transactional
    public int deleteCopyRights(List<Integer> copyRightIdList) throws RuntimeException{
    ...
    //教材
    @Transactional
    public int insertTeachMaterials(List<TeachMaterial> teachMaterialList) throws RuntimeException{
    ...
    @Transactional
    public int deleteTeachMaterials(List<Integer> teachMaterialIdList) throws RuntimeException{
    ...
    //教改
    @Transactional
    public int insertEduReforms(List<EduReform> eduReformList) throws RuntimeException{
    ...
    @Transactional
    public int deleteEduReforms(List<Integer> eduReformIdList) throws RuntimeException{
    ...
    //国际合作
    @Transactional
    public int insertGlobalCooperations(List<GlobalCooperation> globalCooperationList) throws RuntimeException{
    ...
    @Transactional
    public int deleteGlobalCooperations(List<Integer> globalCooperationIdList) throws RuntimeException{
